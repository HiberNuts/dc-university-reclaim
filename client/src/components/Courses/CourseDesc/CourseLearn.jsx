...
export const LearnCard = () => {
  return (
    <div className="bg-shardeumPurple flex gap-4 w-full px-[16px] py-[16px] sm:px-[24px] sm:py-[20px] rounded-[16px]">
      <span className="align-middle justify-center lg:h-[28px] lg:w-[50px] md:w-[80px] md:h-[30px] sm:h-[30px] sm:w-[50px] w-[90px] h-[30px]">
        <img className="w-full h-full" src={check} />
      </span>
      <p className="font-[500]  text-[18px] text-start">
