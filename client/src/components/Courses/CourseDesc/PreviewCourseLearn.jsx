...
export const LearnCard = ({ text }) => {
    return (
        <div className="bg-white  justify-start border-2 border-black align-middle h-auto flex gap-4 w-full px-[16px] py-[16px] sm:px-[24px] sm:py-[20px] rounded-[16px]">
            ...
            <p className="text-[18px] h-full flex-col flex justify-center text-start font-helvetica-neue-roman">{text.title}</p>
        </div>
    );
};

const PreviewCourseLearn = ({ props }) => {
...
export default PreviewCourseLearn;
