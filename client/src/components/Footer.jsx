...
export default function Footer() {
  ...
  return (
    <footer
      className={`p-4 ${profileRoute == "/profile" ? "sticky overflow-hidden h-[350px]" : ""} bg-shardeumBlue sm:p-6`}
    >
      <div className={`mx-auto  max-w-screen-xl`}>
        <div className="md:flex md:justify-between">
          ...
          <div className="flex flex-col gap-2">
            <div>
              <span className="font-satoshi text-[20px] text-white font-semibold">Subscribe to Our Newsletter</span>
            </div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="text-white flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <Link target="_blank" to="https://Decentraclasses.com">
              <span>Made with ❤️ by Decentraclasses.com</span>
            </Link>
          </div>
        </div>
      </div>
