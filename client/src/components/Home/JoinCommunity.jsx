  ...
  return (
    <div className="relative self-stretch w-full rounded-[40px] [background:linear-gradient(180deg,rgba(7,7,7,0.5)_60%,rgba(93,137,255))]">
      <div className="relative  min-h-[687px] top-[-37px]">
        ...
        bg-gradient-to-b from-[#ffffff] to-[#79797b] bg-clip-text font-montserrat-bold text-transparent text-[20px] md:text-[30px] lg:text-[40px] text-center tracking-[0] leading-[60px] whitespace-nowrap">
            Join Our Community
          </div>
