      ...
      <div className=" md:w-[55%] md:flex md:flex-col md:justify-around md:items-start">
        <div>
          ...
          <p className="break-keep text-l">
            DecentraClasses: Learn, Earn, and Stake for a Decentralized Education Revolution. Discover a new era of
            knowledge-sharing where education becomes an asset and learning transforms into earning.
          </p>
        </div>
