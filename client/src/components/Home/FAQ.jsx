...
const FAQ = () => {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto px-4 py-16 relative">
      <div className="size-[596px] rounded-full absolute top-8 left-1/2 -translate-x-1/2 bg-[#3A59FE] blur-[300px] opacity-50 z-0"></div>
      <h2 className="bg-gradient-to-r from-[#ffffff] to-[#79797b] bg-clip-text font-orbitron font-bold text-transparent  text-[40px] tracking-[0] leading-[50px] whitespace-nowrap mb-10 text-center z-[999]">Frequently Asked Questions</h2>
