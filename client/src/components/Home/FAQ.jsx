...
const FAQ = () => {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto px-4 py-16 relative">
      ...
      <h2 className="bg-gradient-to-r from-[#ffffff] to-[#79797b] bg-clip-text font-orbitron font-bold text-transparent  lg:text-[40px] text-[20px] sm:text-[30px] tracking-[0] lg:leading-[50px] sm:leading-[40px] leading-[30px] whitespace-nowrap mb-10 text-center z-[999]">Frequently Asked Questions</h2>
