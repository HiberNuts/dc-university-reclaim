...
const Testimonials = () => {
  return (
    <div className="flex flex-col items-center justify-center gap-10 p-20 relative self-stretch w-full flex-[0_0_auto]">
          ...
          {/* testimonials cards */}
          <div className="justify-center gap-5 flex items-start relative self-stretch w-full flex-[0_0_auto]">
