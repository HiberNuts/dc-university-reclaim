...
const styleNavEl =
  "before:bg-white before:left-0  hover:text-white text-white before:transition-transform hover:before:scale-x-100 before:scale-x-0  before:duration-300 before:flex before:w-full before:h-[2px] relative before:absolute before:bottom-[-4px] before:rounded-full ";
const activeNavEl =
  "before:bg-white text-white before:left-0 text-white before:transition-transform  before:scale-x-100 before:duration-300 before:flex before:w-full before:h-[2px] relative before:absolute before:bottom-[-4px] before:rounded-full";
