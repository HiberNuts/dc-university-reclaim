...
const RedButton = ({ title, style, icon, iconRight, onClick }) => {
  return (
    <button
      ...
      className={`bg-shardeumRed cursor-default  rounded-[10px] border-2 border-black  transition ease-in-out items-center  align-middle text-center text-white text-[22px] ${style}`}
    >
