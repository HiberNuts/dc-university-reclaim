const ProfileProjectCard=(props)=>{
    return <div className="h-[275px] border rounded-[20px] w-[100%] col-span-1 cursor-pointer hover:w-[105%] transition-width duration-1000 ease-in-out" style={{boxShadow: "6px 6px 0px 0px #00000026"}}>
