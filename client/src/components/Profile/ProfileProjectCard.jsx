const ProfileProjectCard = (props) => {
    ...
    return (
        <div className="border-[0.1px] border-decentraBlue h-[156px] rounded-[12px] grid grid-cols-6 gap-3 p-2 shadow-xl cursor-pointer hover:p-2 transition-padding duration-500 ease-in-out  [background:linear-gradient(180deg,rgb(19.6,19.6,20)_60%,rgba(58,89,254,0.3)_100%)]">
