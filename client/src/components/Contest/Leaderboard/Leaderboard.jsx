...
import first_trophy from "../../../assets/small-trophy-1.png";
import second_trophy from "../../../assets/small-trophy-2.png";
import third_trophy from "../../../assets/small-trophy-3.png";
...
export default function Leaderboard({ data }) {
    ...
    const renderTrophy = (index) => {
        ...
        return (
            <div className="absolute w-[184px] h-[184px] top-0 left-[52.5%]">
        ...
        <div className="flex flex-col gap-10 pt-[60px] pb-20 self-stretch w-full items-start relative flex-[0_0_auto]">
            <div className="flex-col items-start justify-center rounded-[20px] overflow-hidden border-2 border-solid border-decentraBlue shadow-[0px_0px_200px_#3a59fe80] flex relative self-stretch w-full flex-[0_0_auto]">
                ...
                <div className="w-full overflow-x-auto overflow-y-hidden">
                    {/* Header */}
                    <div className="min-w-[1100px] items-center [background:linear-gradient(180deg,rgb(92.65,136.59,255)_0%,rgb(58,89,254)_100%)] flex relative flex-[0_0_auto]">
                        ...
                        <div className="flex flex-col w-[600px] items-start justify-center px-4 sm:px-11 py-8 relative">
                            <div className="relative w-fit mt-[-1.00px] [font-family:'Gilroy-Bold',Helvetica] font-bold text-white text-xl tracking-[2.40px] leading-5 whitespace-nowrap">
                                USER NAME
                            </div>
                        </div>
                    ...
                    {/* Leaderboard rows */}
                    {data.slice(0, showAll).map((item, index) => (
                        <div key={index} className={`min-w-[1100px] items-center border-b [border-bottom-style:solid] border-[#ffffff33] flex relative overflow-hidden self-stretch w-full flex-[0_0_auto] ${index === 0 ? 'bg-[#61dd38]/15' :
                            ...
                            }`}>
                            {
                                ...
                                <div className="overflow-hidden">
                                    <img
                                        className="opacity-[0.05] w-[367px] h-[236px] top-0 left-0 absolute object-cover"
                                        alt="Image"
                                        src={image41}
                                    />
                                    <img
                                        className="opacity-[0.05] w-[367px] h-[336px] top-0 left-[27.5%] absolute object-cover"
                                        alt="Image"
                                        src={image41}
                                    />
                                    <img
                                        className="opacity-[0.05] w-[367px] h-[336px] top-0 left-[55%] absolute object-cover"
                                        alt="Image"
                                        src={image41}
                                    />
                                    <img
                                        className="opacity-[0.05] w-[367px] h-[336px] top-0 left-[82.5%] absolute object-cover"
                                        alt="Image"
                                        src={image41}
                                    />
                            ...
                            {index < 3 && renderBackgroundEffects(index)}
                            {index < 3 && renderTrophy(index)}
                            ...
                            <div className="flex w-[150px] h-[72px] items-center justify-center px-4 sm:px-11 py-0 relative">
                                ...
                                {index < 3 && (
                                    <div className={`absolute w-[26px] h-[26px] top-[22px] left-[35px] bg-[url(assets/small-trophy-${index + 1}.png)] bg-[100%_100%]`} />
                                )}
                            </div>
                            ...
                            <div className="flex flex-col w-[220px] h-[72px] items-center justify-center px-4 sm:px-11 py-0 relative">
                                <div className="inline-flex items-center justify-center relative flex-[0_0_auto]">
                                    ...
                                    <div className="relative w-[41px] h-3.5 [font-family:'Helvetica_Neue_LT_Pro-Md',Helvetica] font-normal text-white text-lg tracking-[0] leading-[18px] whitespace-nowrap">
                                        {item["Amount Earned"] ? item["Amount Earned"].substring(1) : '--'}
                                    </div>
                                </div>
                            </div>
                        </div>
