    ...
    <div>
      ...
      <div className="max-w-[1440px] flex md:flex-row flex-col md:mx-[4em] lg:mx-[4em] m-0 justify-center mt-10">
        <div className="md:w-[40%] md:mx-20 mx-5">
          <motion.h1
            className="font-bold md:text-[2.25em] text-[22px]"
            ...
            custom={1}
          >
            Community-power learning among people like you
          </motion.h1>
          <motion.p
            className="my-8 font-semibold md:text-[1em] text-sm"
            variants={slideAnimateVariants}
            initial="initial"
            whileInView="animate"
            viewport={{
          ...
          <a href="https://t.me/decentraclasses" target="_blank" rel="noreferrer">
            <motion.button
              className="p-3 rounded-full font-bold bg-yellow-400"
              variants={slideAnimateVariants}
              initial="initial"
              whileInView="animate"
              viewport={{
      ...
      <div className="flex md:flex-row flex-col justify-center">
        <motion.div
          className="md:w-[30%]  mx-2 md:mx-5 bg-slate-300 p-5 rounded-lg mb-3"
          variants={fadeAnimateVariants}
          initial="initial"
          whileInView="animate"
          viewport={{
        ...
        <motion.div
          className="md:w-[30%]  md:mx-0 bg-slate-300 p-5 mx-5 rounded-lg flex"
          variants={fadeAnimateVariants}
          initial="initial"
          whileInView="animate"
          viewport={{
      ...
      <div className="flex md:flex-row flex-col justify-center mt-5">
        <motion.div
          className="md:w-[30%] mx-2 md:mx-5 bg-slate-300 p-5 rounded-lg flex"
          variants={fadeAnimateVariants}
          initial="initial"
          whileInView="animate"
          viewport={{
        ...
        <motion.div
          className="md:w-[30%] mx-5 md:mx-0 mt-5 bg-slate-300 p-5 rounded-lg mb-3"
          variants={fadeAnimateVariants}
          initial="initial"
          whileInView="animate"
          viewport={{
      ...
      <div className="flex md:flex-row flex-col align-middle justify-center md:mt-20">
        ...
        <motion.div
          className="hidden md:content-center md:flex justify-center"
      ...
      <div className="flex md:flex-row flex-col align-middle justify-center md:mt-20">
        <div className="md:w-[40%] mx-5 mt-20">
          ...
          <p className="font-semibold">
            Good at coding? Great! Our advanced stage includes sspecial resources and interactive lessons designed to
            get you going on your fabulous journey of mastering Web 3 technology.
          </p>
        </div>
        <motion.div
          className="hidden md:content-center md:flex justify-center"
